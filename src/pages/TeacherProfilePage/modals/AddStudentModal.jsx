...
export default function AddStudentModal({ open, onClose, onSubmit }) {
  ...
  return (
    <Modal
      ...
      variant="slideRight"
    >
      <div className="pp__panel spModal__container">
                  ...
                  <div className="spModal__grid">
                    ...
                    <label className="spModal__field">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setField("studentEmail", e.target.value)
                        }
                        required
                        disabled={busy}
                      />
              ...
              <section className="spModal__section">
                ...
                <div className="spModal__sectionBody">
                  ...
                  <p className="spModal__hint">
                    If you add a parent email now, you can later email the
                    parent automatically using “Save &amp; Share”.
                  </p>
                </div>
              </section>
