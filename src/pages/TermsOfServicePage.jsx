    ...
    <main className="legalPage">
      <div className="legalPage__container">
        ...
        <section className="legalPage__section">
          ...
          <ol>
            <li>
              Teachers: Music instructors who create and manage student
              accounts, assign homework, track progress, and communicate with
              parents.
            </li>
            <li>
              Students: Individuals receiving music instruction. Students under
              18 must have parental consent to use the platform.
            </li>
            <li>
              Parents/Guardians: Adults who monitor their child's progress,
              communicate with teachers, and manage account settings for minors.
            </li>
          </ol>
        ...
        <section className="legalPage__section">
          ...
          <p>
            ...
            risk to the safety of minors or other users.
          </p>
        </section>
        ...
        <section className="legalPage__section">
          ...
          <p>
            StudioPulse is provided "as is" without warranties of any kind. We
            are not responsible for the quality of instruction, student
            progress, or educational outcomes. To the maximum extent permitted
            by law, StudioPulse shall not be liable for any indirect,
        ...
        <section className="legalPage__section">
          ...
          <p>StudioPulse</p>
          <p>Email: legal@studiopulse.co</p>
