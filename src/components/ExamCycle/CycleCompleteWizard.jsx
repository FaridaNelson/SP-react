...
export default function CycleCompleteWizard({
  ...
  async function handleComplete() {
    if (!examResult) {
      setErr("Please select an overall result.");
      return;
    }
    setBusy(true);
    setErr("");
    try {
      const payload = {
        examTaken: true,
        examDate: cycle?.examDate || new Date().toISOString(),
          ...
          ...(!isPerformance
            ? {
                componentScores: {
                  ...
                  sightReading: sightScore
                    ? parseInt(sightScore, 10)
                    : undefined,
      ...
      <div className="ccw__viewBody">
        ...
        >
          ...
          <div className="ccw__optionText">
            ...
            <div className="ccw__optionDesc">
              Enter exam results and mark cycle as completed
            </div>
          </div>
        </button>
    ...
    return (
      <div className="ccw__viewBody">
        ...
        <div className="ccw__warning">
          This cycle will be marked as Withdrawn. You can start a new cycle for
